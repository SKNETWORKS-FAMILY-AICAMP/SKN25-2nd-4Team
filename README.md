...
## 📕 프로젝트명
핀-케어(Fin-Care): 행동 편향 기반 이탈 및 자산 유출 예측
## ✅ 프로젝트 배경 및 목적
...
<h3>🎯 Core Value for Users</h3>

<ul>
  <li>✔ 단순 예측이 아닌 <b>"이유까지 설명 가능한"</b> 시스템</li>
  <li>✔ 고위험 고객 우선순위 자동화</li>
  <li>✔ 실시간 시뮬레이션 기반 의사결정 지원</li>
  <li>✔ 데이터 기반 고객 유지 전략 고도화</li>
</ul>
## 👤 대상 사용자
